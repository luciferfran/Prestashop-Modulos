...
class redsys extends PaymentModule
{
	...
	public function __construct(){
		...
		$config = Configuration::getMultiple(array('REDSYS_URLTPV', 'REDSYS_CLAVE', 'REDSYS_NOMBRE', 'REDSYS_CODIGO', 'REDSYS_TERMINAL', 'REDSYS_TIPOFIRMA', 'REDSYS_RECARGO', 'REDSYS_MONEDA', 'REDSYS_TRANS', 'REDSYS_NOTIFICACION', 'REDSYS_SSL', 'REDSYS_ERROR_PAGO', 'REDSYS_IDIOMAS_ESTADO'));
		...
		$this->description = $this->l('Aceptar pagos con tarjeta v&iacute;a Redsys');
		...
		$this->warning = $this->l('Faltan datos por configurar del m&oacute;dulo Redsys.');
	}
		...
		'<form action="'.$_SERVER['REQUEST_URI'].'" method="post">
			...
			<legend><img src="../img/admin/contact.gif" />'.$this->l('Configuraci&oacute;n del TPV').'</legend>
				<table border="0" width="680" cellpadding="0" cellspacing="0" id="form">
					<tr><td colspan="2">'.$this->l('Por favor completa la informaci&oacute;n requerida que te proporcionar&aacute; tu banco Redsys.').'.<br /><br /></td></tr>
